...
document.getElementById("get").addEventListener("click", radioGetDelete);
document.getElementById("post").addEventListener("click", radioPost);
document.getElementById("put").addEventListener("click", radioPutPatch);
document.getElementById("patch").addEventListener("click", radioPutPatch);
document.getElementById("delete").addEventListener("click", radioGetDelete);
// Event listener triggered when "Send Request" button is clicked
document.getElementById("SendRequest").addEventListener("click", getRequestType);
